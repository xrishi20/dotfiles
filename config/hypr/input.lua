...
-- System Binds
hl.bind("ALT + escape", hl.dsp.window.close(window))
...
hl.bind("SUPER + period", hl.dsp.exec_cmd("noctalia msg panel-toggle control-center"))
hl.bind("SUPER + space", hl.dsp.exec_cmd("noctalia msg panel-toggle launcher"))
hl.bind("SUPER + SHIFT + delete", hl.dsp.exec_cmd("noctalia msg panel-toggle session"))
...
hl.bind("SUPER + K",
   hl.dsp.exec_cmd(
      "hyprpicker --format hex| head -c -1 | wl-copy && noctalia msg notification-show \"$(wl-paste)\" 'Copied to your clipboard!'"))
...
hl.bind("SUPER + plus", hl.dsp.layout("splitratio +0.1"))
